...
public class Bass {
	...
	public void makeTracks(int[] list) {		//makes events for one instrument at a time, for all beats
		...
		for (int i = 0; i < sectionLength; i++) {
			...
			// 1
			if (key == 1) {
				track.add(makeEvent(144, 8, 36, 100, i));
				track.add(makeEvent(128, 8, 36, 100, i+1));
			}
			
			// b2
			if (key == 2) {
				track.add(makeEvent(144, 8, 37, 100, i));
				track.add(makeEvent(128, 8, 37, 100, i+1));
			}
			
			// 2
			if (key == 3) {
				track.add(makeEvent(144, 8, 38, 100, i));
				track.add(makeEvent(128, 8, 38, 100, i+1));
			}
						
			// b3
			if (key == 4) {
				track.add(makeEvent(144, 8, 39, 100, i));
				track.add(makeEvent(128, 8, 39, 100, i+1));
			}
			
			// 3
			if (key == 5) {
				track.add(makeEvent(144, 8, 40, 100, i));
				track.add(makeEvent(128, 8, 40, 100, i+1));
			}			
			
			// 4
			if (key == 6) {
				track.add(makeEvent(144, 8, 41, 100, i));
				track.add(makeEvent(128, 8, 41, 100, i+1));
			}
			
			// b5
			if (key == 7) {
				track.add(makeEvent(144, 8, 42, 100, i));
				track.add(makeEvent(128, 8, 42, 100, i+1));
			}
			
			// 5
			if (key == 8) {
				track.add(makeEvent(144, 8, 43, 100, i));
				track.add(makeEvent(128, 8, 43, 100, i+1));
			}
			
			// b6
			if (key == 9) {
				track.add(makeEvent(144, 8, 44, 100, i));
				track.add(makeEvent(128, 8, 44, 100, i+1));
			}
			
			// 6
			if (key == 10) {
				track.add(makeEvent(144, 8, 45, 100, i));
				track.add(makeEvent(128, 8, 45, 100, i+1));
			}
			
			// b7
			if (key == 11) {
				track.add(makeEvent(144, 8, 46, 100, i));
				track.add(makeEvent(128, 8, 46, 100, i+1));
			}
			
			// 7
			if (key == 12) {
				track.add(makeEvent(144, 8, 47, 100, i));
				track.add(makeEvent(128, 8, 47, 100, i+1));
			}
		}
	}
